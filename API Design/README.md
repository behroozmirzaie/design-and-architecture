...
* Wed Feb 02 2022 00:01:59 GMT-0800 (PST)
...
* سواپ SOAP بر اساس قرارداد است، بنابراین یک tight coupling بین client application  و سرور وجود دارد.
* سوآپ SOAP کند است زیرا Payload برای یک پیام رشته ای ساده بزرگ است چون از فرمت XML استفاده می کند.
